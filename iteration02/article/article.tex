...
\subsubsection{K-vizinhos-mais-próximos}
\begin{equation}
k = round(\sqrt{nrow(dadosteste)})=12\label{8c_k}
\end{equation}
Antes da realização do algoritmo knn, foi necessária a separação da variável em estudo (“ClassedeRisco”) dos restantes dados de treino e teste. Após esta divisão, calculou-se o valor de k através da equação \eqref{8c_k}, com o resultado obtido presente na mesma.
