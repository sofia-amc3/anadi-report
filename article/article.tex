...
Após a realização e conclusões retiradas com o teste ANOVA, realizou-se um teste post-hoc com o objetivo de perceber mais sobre as diferenças das médias dos dados entre os continentes. Assim sendo, realizou-se um teste Tukey’s Honest Significant Difference (X), com o qual se obteve os dados apresentados na figura abaixo.
